     ...
     switch(current_state){
          case 0: // S0 - Todo apagado
               ...
               if((sn_PosEdge_1 == 1) && (clock0 == 1)){
                    next_state = 10; // Si, pasamos a estado 6
               }
               else{
          ...
          case 7:
               ...
               break;
          case 8: // S4 - Grupo de trabajo 4 111
               M1 = 1;
               M2 = 1;
               M3 = 1;
               M4 = 1;
               ...
               break;
          case 9: // S5 - Estado de transicion para flanco negativo 2
               ...
               break;
          case 10: // S6 - Estado de transicion para flanco positivo
               if(sn_PosEdge_1){
