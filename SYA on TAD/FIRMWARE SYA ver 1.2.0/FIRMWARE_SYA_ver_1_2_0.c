...
#define M5 LATB.F0 // Actuador 5 en B0 (placeholder)
     ...
     switch(current_state){
          case 0: // S0 - Todo apagado
               ...
               if((sn_PosEdge_1 == 1) && (clock0 == 1)){
                    next_state = 13; // Si, pasamos a estado 6
               }
               else{
          ...
          case 10:
               ...
               // Si no,
                    ...
                    // Quedate en estado 1
                    next_state = 10; //(Revisar de nuevo)
               }
               break;
          case 11: // S4 - Grupo de trabajo 4 111
               M1 = 1;
               M2 = 1;
               M3 = 1;
               M4 = 1;
               ...
               // Si no,
                    ...
                    // Quedate en estado 4
                    next_state = 11; //(Revisar de nuevo)
               }
               break;
          case 12: // S5 - Estado de transicion para flanco negativo 2
               ...
               break;
          case 13: // S6 - Estado de transicion para flanco positivo
               if(sn_PosEdge_1){
