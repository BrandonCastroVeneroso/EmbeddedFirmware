...
sfr unsigned short volatile INT0PPS          absolute 0xEA1;
    ...
    const register unsigned short int INT0PPS4 = 4;
    sbit  INT0PPS4_bit at INT0PPS.B4;
...
sfr unsigned short volatile ADCON0           absolute 0xF60;
    ...
    const register unsigned short int GODONE = 2;
    sbit  GODONE_bit at ADCON0.B2;
...
sfr unsigned int   volatile SPBRG            absolute 0xF9B;
...
sfr unsigned short volatile SPBRGH           absolute 0xF9C;
...
sfr unsigned short volatile BAUDCON          absolute 0xF9F;
